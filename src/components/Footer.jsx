...
const Footer = () => {
    ...
    <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center md:items-start gap-12">
        ...
        {/* MIDDLE: Contact Info */}
        <div className="flex flex-col items-center md:items-start gap-3 font-body text-sm text-center md:text-left">
            ...
            <div className="flex items-center gap-2">
                ...
                <a
                    href="https://maps.app.goo.gl/EXFU8Rdzeao4bxD47"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-white transition-colors"
                >
        ...
        <div className="flex flex-col items-center md:items-end gap-6 w-full md:w-auto">
            ...
            {/* Map */}
            <div className="w-full max-w-xs md:w-64 h-40 rounded-xl overflow-hidden border border-neutral-cream/20">
                <iframe
            ...
            <div className="flex flex-col items-center md:items-end gap-2">
                ...
                <div className="flex gap-3">
                    <a
                        href="https://www.instagram.com/himadri.herbals/"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    >
                        ...
                        >
                            <path d="M16.04 2.4c-7.52 0-13.64 6.12-13.64 13.64 0 2.4.63 4.74 1.83 6.8L2.4 29.6l6.96-1.83c1.98 1.08 4.2 1.66 6.68 1.66h.01c7.52 0 13.64-6.12 13.64-13.64S23.56 2.4 16.04 2.4z" />
                        </svg>
                    </a>
                </div>
            </div>
